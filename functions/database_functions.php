<?php
	function db_connect(){
		$conn = mysqli_connect("cloudbookstorecc-server.mysql.database.azure.com", "vzxhyrpain", "VO706ZUN4Z57MI1R$", "sourcecodester_bookstoredb",3306, NULL, MYSQL_ATTR_SSL_CA);
		if(!$conn){
